...
namespace EZ_Core
{
    public static class Collider2DExtension
    {
        ...
        /// <returns></returns>
        public static bool CompareTag(this Collider2D col, Tag tag)
        {
            var tagger = col.GetComponent<EZ_Tagger>();
			if (tagger == null)
			{
        ...
        /// <returns></returns>
        public static bool CompareTag(this Collider2D col, List<Tag> tags, Matcher matcher = Matcher.Exact)
        {
            var tagger = col.GetComponent<EZ_Tagger>();
			if (tagger == null)
			{
